  ...
  return (
    <main className="min-h-screen bg-amber-50">
      ...
      <nav className="flex items-center justify-between px-8 py-4 bg-white shadow-sm">
        ...
        <span className="text-sm text-gray-500">Hey, {session.user.name}!</span>
      </nav>

      <div className="max-w-4xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-extrabold text-gray-900">Your rooms</h1>
            <p className="text-gray-400 mt-1">All your gift missions, in one place.</p>
          </div>
          <Link
            href="/room/create"
        ...
        {rooms.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-2xl border border-dashed border-amber-200">
            ...
            <p className="text-gray-400 text-sm mt-1">Create one and start the gifting mission!</p>
